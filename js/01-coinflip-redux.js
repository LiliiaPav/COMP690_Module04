...
let coinFlip;
const amountLoops = Number(prompt("Select the amount of times that the for loop executes "));
for (i=1; i<=amountLoops; i++){
    coinFlip = Math.round(Math.random());
    if (coinFlip===0) {  console.log('Heads');} //Heads
    else {console.log('Tails');} //Tails.
 }